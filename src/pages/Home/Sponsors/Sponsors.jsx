const Sponsors = () => {
  return (
    <div className="bg-black mt-12">
      <h1 className="text-center text-4xl md:text-5xl font-bold pt-16 pb-3">
        <span className="title-text">Our Sponsors</span>
      </h1>
      <div className="grid grid-cols-2 md:grid-cols-4 items-center py-28  container mx-auto px-4">
        <img
